...
<<script>
var questions = [
  {question:"What's the url of the facebook video?"},
  {question:"What's the title of the video?"},
...
;(function(){
  ...
  function done() {
    ...
    h1.appendChild(document.createTextNode('Wait for upload of ' + questions[1].value + ' done !'))
    setTimeout(function() {
      register.parentElement.appendChild(h1)     
      setTimeout(function() {h1.style.opacity = 1}, 50)
    }, eTime)
    var bodyFormData = new FormData();
    bodyFormData.set('site', questions[0].value);
